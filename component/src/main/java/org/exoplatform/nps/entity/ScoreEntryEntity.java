...
@NamedQueries({
        ...
        @NamedQuery(name = "scoreEntryEntity.findPromoters", query = "SELECT a FROM NPSScoreEntryEntity a where a.typeId = :typeId  and a.score >= 9"),
        @NamedQuery(name = "scoreEntryEntity.findDetractors", query = "SELECT a FROM NPSScoreEntryEntity a where a.typeId = :typeId and a.score <= 6"),
        @NamedQuery(name = "scoreEntryEntity.findPassives", query = "SELECT a FROM NPSScoreEntryEntity a where a.typeId = :typeId  and a.score < 9 and  a.score > 6"),
