@Portlet
@Application(name = "NPSChartsController")
@Bindings({
...
@Scripts({
    ...
    @Script(id = "npschartsAddon", value = "js/nps-charts.js", depends = { "controllers","jQueryUI" }) })

@Stylesheets({
        @Stylesheet(id = "jQueryUISkin", value = "style/jquery-ui.css") ,
        @Stylesheet(id = "nps-charts", value = "style/nps-charts.css") })
